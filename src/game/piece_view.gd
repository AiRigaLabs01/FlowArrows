...
func _draw() -> void:
	...
	var body_color := Color(0.93, 0.94, 0.97, 1.0) if enabled else Color(0.42, 0.44, 0.49, 1.0)
	if hinted:
	...
	var tip := points[-1] + Vector2(direction) * cell_size * 0.30
	var back := tip - Vector2(direction) * HEAD_LENGTH
